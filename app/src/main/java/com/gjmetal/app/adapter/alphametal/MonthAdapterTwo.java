...
public class MonthAdapterTwo extends SimpleRecAdapter<RoomItem, MonthAdapterTwo.MyViewHolder> {
    private Context mContext;
    private OnItemClickListener mOnItemClickListener;
    private int mType = 0; //0 : 涨跌; 1 : 涨幅


    public MonthAdapterTwo(Context context) {
        super(context);
        mContext = context;
    }
    ...
    public void onBindViewHolder(MyViewHolder holder,  int position) {
        final RoomItem specific = data.get(position);
        if (position % 2 == 0) {
        ...
        GjUtil.setNoDataHide(mContext, holder.tvMonthNameRemark, specific.getDescribe());
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mOnItemClickListener != null) {
                    mOnItemClickListener.onClick(v, specific);
                }
            }
        });
        ...
        holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                if (ValueUtil.isNotEmpty(specific)) {
                    if (mOnItemClickListener != null) {
                        mOnItemClickListener.onLongClick(v, specific);
                    }
                }
    ...
    public void spanItemTop(RoomItem specific) {
        data.add(0, specific);
        notifyDataSetChanged();
    }

    public void updateDatas(List<RoomItem> specifics) {
