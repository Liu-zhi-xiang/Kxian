...
//    Calendar mIndexCalendar;
    ...
    CustomCalendarViewDelegate(Context context, @Nullable AttributeSet attrs) {
        ...
        mCurDayTextColor = array.getColor(R.styleable.CalendarView_current_day_text_color, Color.BLACK);
        mCurDayLunarTextColor = array.getColor(R.styleable.CalendarView_current_day_lunar_text_color, Color.BLACK);

        mSelectedThemeColor = array.getColor(R.styleable.CalendarView_selected_theme_color, 0x50CFCFCF);//今天
