...
public class ImageViewer implements OnDismissListener, DialogInterface.OnKeyListener {
    ...
    private void createDialog() {
        ...
        viewer.setImageChangeListener( builder.imageChangeListener);
    ...
    public interface OnImageChangeListener {
        ...
        void onImgFailure(int position);
    }
    ...
    public static class Builder<T> {
        ...
        public Builder setBackgroundColorRes(@ColorRes int color) {
            return this.setBackgroundColor(ContextCompat.getColor(context,color));
        }
