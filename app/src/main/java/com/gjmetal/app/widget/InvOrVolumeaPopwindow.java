...
import com.gjmetal.app.adapter.alphametal.InvOrVolumeaAdapter;
...
//        showAsDropDown(mView);
    ...
    public void setTextValue(String volume, String volumeNum, String inventory, String inventoryNum) {
        if (ValueUtil.isStrEmpty(volume)){
            tvInventoryNum.setText("- -");
        }else {
            tvInventoryNum.setText(volume);
        }
        if (ValueUtil.isStrEmpty(volumeNum)){
            tvInventory.setText("- -");
        }else {
            tvInventory.setText(volumeNum);
        }
        if (ValueUtil.isStrEmpty(inventory)){
            tvVolumeNum.setText("- -");
        }else {
            tvVolumeNum.setText(inventory);
        }
        if (ValueUtil.isStrEmpty(inventoryNum)){
            tvVolume.setText("- -");
        }else {
            tvVolume.setText(inventoryNum);
        }
    }
