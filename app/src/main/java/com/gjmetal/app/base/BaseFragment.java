...
public abstract class BaseFragment extends Fragment implements View.OnTouchListener {
    protected String token = SharedUtil.get(Constant.TOKEN);
    protected User user = User.getInstance().getUser();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        XLog.d("BaseFragment","onCreateView");
        initView();
        return v;
    }
    ...
    public void onStart() {
        super.onStart();
//        SocketManager.getInstance().firstChectStatus(getActivity());
    }
    ...
    public void onDestroyView() {
        ...
        XLog.d("BaseFragment","onDestroyView");
        if (v != null) {
    ...
    public void onResume() {
        super.onResume();
//        AppAnalytics.getInstance().onResume(getActivity());
    }

    @Override
    public void onPause() {
        super.onPause();
//        AppAnalytics.getInstance().onPause(getActivity());
    }
}
