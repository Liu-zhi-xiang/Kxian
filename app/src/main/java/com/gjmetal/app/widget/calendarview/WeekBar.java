...
public class WeekBar extends LinearLayout {
    ...
    public WeekBar(Context context) {
        super(context);
        if ("com.gjmetal.app.widget.calendarview.WeekBar".equals(getClass().getName())) {
    ...
    void setup(CustomCalendarViewDelegate delegate) {
        ...
        if ("com.gjmetal.app.widget.calendarview.WeekBar".equalsIgnoreCase(getClass().getName())) {
