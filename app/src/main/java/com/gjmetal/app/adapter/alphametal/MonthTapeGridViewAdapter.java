...
public class MonthTapeGridViewAdapter extends BaseAdapter {
    private Context mContext;
    private List<TapeSocket.BlocksBean.ItemsBean> dataList;
    private float preClose = 0;
    private boolean isPreClose=true;
    public MonthTapeGridViewAdapter(Context context, List<TapeSocket.BlocksBean.ItemsBean> dataList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        }else if(name.equals("卖量") || name.equals("买量") || name.contains("- -") || name.contains("-")){
            holder.tvValue.setTextColor(ContextCompat.getColor(mContext, R.color.cFFFFFF));
