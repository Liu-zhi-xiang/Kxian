...
public class PhotoSelectActivity extends PhotoBaseActivity implements View.OnClickListener, AdapterView.OnItemClickListener{
    ...
    private void findViews() {
        mGvPhotoList = findViewById(R.id.gv_photo_list);
        mLvFolderList = findViewById(R.id.lv_folder_list);
        mTvSubTitle = findViewById(R.id.tv_sub_title);
        mLlFolderPanel = findViewById(R.id.ll_folder_panel);
        mIvTakePhoto = findViewById(R.id.iv_take_photo);
        mTvChooseCount = findViewById(R.id.tv_choose_count);
        mIvBack = findViewById(R.id.iv_back);
        mFabOk = findViewById(R.id.fab_ok);
        ...
        mIvFolderArrow = findViewById(R.id.iv_folder_arrow);
