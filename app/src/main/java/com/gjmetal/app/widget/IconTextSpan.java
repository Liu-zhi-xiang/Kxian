...
public class IconTextSpan extends ReplacementSpan {
    ...
    private void initDefaultValue(Context context, int bgColorResId, String text) {
        ...
        this.mRadius = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 0, mContext.getResources().getDisplayMetrics());
        this.mTextSize = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 13, mContext.getResources().getDisplayMetrics());
        this.mTextColorResId = R.color.cFFFFFFFF;
    }
    ...
    public void setTextSize(int size){
        this.mTextSize=TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, size, mContext.getResources().getDisplayMetrics());
        //初始化画笔
        initPaint();
    }
