...
public class ClearEditText extends android.support.v7.widget.AppCompatEditText implements OnFocusChangeListener, TextWatcher
{
	...
	private void init() {
		...
		if (mClearDrawable == null) {
			mClearDrawable = ContextCompat.getDrawable(getContext(),R.mipmap.ic_delete_input_res);
		}
		mClearDrawable.setBounds(0, 0, mClearDrawable.getIntrinsicWidth()-30, mClearDrawable.getIntrinsicHeight()-30);
