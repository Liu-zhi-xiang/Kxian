...
class ImageViewerAdapter
    ...
    public ImageViewerAdapter setImageChangeListener(ImageViewer.OnImageChangeListener imageChangeListener) {
    ...
    getDraweeControllerListener(final ZoomableDraweeView drawee,final  int p) {
        return new BaseControllerListener<ImageInfo>() {
            ...
            public void onFinalImageSet(String id, ImageInfo imageInfo, Animatable animatable) {
                ...
                if (imageChangeListener!=null){
                    imageChangeListener.onImgFailure(p);
                }
            }
        };
    }
    ...
    class ImageViewHolder extends ViewHolder implements OnScaleChangeListener {
        ...
        void bind(int position) {
            ...
            tryToSetHierarchy();
            setController(dataSet.format(position),position);
        ...
        private void setController(String url,int position) {
            PipelineDraweeControllerBuilder controllerBuilder = Fresco.newDraweeControllerBuilder();
            controllerBuilder.setUri(url);
            controllerBuilder.setOldController(drawee.getController());
            controllerBuilder.setControllerListener(getDraweeControllerListener(drawee,position));
